...
import com.youshail.ecommerce.app.databinding.CartProductItemBinding
import com.youshail.ecommerce.app.helper.getProductPrice
    ...
    inner class CartProductViewHolder(val binding: CartProductItemBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(cartProduct: CartProduct){
            binding.apply {
                ...
                tvProductCartPrice.text = "${String.format("%.2f", priceAfterPercentage)} DH"
